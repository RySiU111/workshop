...
namespace Workshop.API.Migrations
{
    ...
    [Migration("20220218214919_InvoiceWorkHoursBruttoNetto")]
    partial class InvoiceWorkHoursBruttoNetto
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Workshop.API.Entities.BasketItem", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
                    ...
                    b.Property<int>("BasketItemState")
                        .HasColumnType("integer");

                    b.Property<DateTime>("DateOfAddedToCart")
            ...
            modelBuilder.Entity("Workshop.API.Entities.CalendarEntry", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
            ...
            modelBuilder.Entity("Workshop.API.Entities.Customer", b =>
                {
                    ...
                    b.Property<bool>("ConsentToTheProcessingOfPersonalData")
                        .HasColumnType("boolean");
            ...
            modelBuilder.Entity("Workshop.API.Entities.Invoice", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
                    ...
                    b.Property<DateTime>("DateOfCeation")
                        .HasColumnType("timestamp without time zone");
                    ...
                    b.Property<double>("WorkHoursPriceBrutto")
                        .HasColumnType("double precision");

                    b.Property<double>("WorkHoursPriceNetto")
                        .HasColumnType("double precision");
            ...
            modelBuilder.Entity("Workshop.API.Entities.KanbanComment", b =>
                {
                    ...
                    b.Property<bool>("IsInnerComment")
                        .HasColumnType("boolean");
            ...
            modelBuilder.Entity("Workshop.API.Entities.Photo", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
            ...
            modelBuilder.Entity("Workshop.API.Entities.User", b =>
                {
                    ...
                    b.Property<DateTime?>("DateOfTerminationOfEmployment")
                        .HasColumnType("timestamp without time zone");
            ...
            modelBuilder.Entity("Workshop.API.Entities.CalendarEntry", b =>
                {
                    b.HasOne("Workshop.API.Entities.Subtask", "Subtask")
